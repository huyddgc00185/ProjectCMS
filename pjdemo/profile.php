				...
				<div class="row">
						...
						<div class="row">
							<div class="col-md-2 col-sm-2">
								<div class="image-user">
									<a href="#"><img src="images/img-user.png"></a>
								</div>
							</div>
					...
					<div class="col-md-4">
						<div class="administration">
							<h3><i class="fa fa-cogs" aria-hidden="true"></i>Administration</h3>
							<ul>
								<li>
									<i class="fa fa-circle-o" aria-hidden="true"></i><a href="#">Edit profile</a>
								</li>
								<li>
									<i class="fa fa-circle-o" aria-hidden="true"></i><a href="#">Messaging</a>
								</li>
								<li>
									<i class="fa fa-circle-o" aria-hidden="true"></i><a href="#">Post</a>
								</li>
								<li>
									<i class="fa fa-circle-o" aria-hidden="true"></i><a href="#">My courses</a>
								</li>
							</ul>
						</div>
					</div>
