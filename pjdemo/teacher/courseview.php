					...
					<ul>
						...
						<li>
							<a href="#">
								...
								<?php 
									$sqlfi1 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND folder = '1' ";
						...
						<li>
							<a href="#">
								...
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi1 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND folder = '2' ";
									$resultfi1 = mysqli_query($connection,$sqlfi1);
									while($rowfi1 = mysqli_fetch_object($resultfi1)){ ?>
						...
						<li>
							<a href="#">
								...
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi1 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND folder = '3' ";
									$resultfi1 = mysqli_query($connection,$sqlfi1);
									while($rowfi1 = mysqli_fetch_object($resultfi1)){ ?>
						...
						<li>
							<a href="#">
								...
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi1 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND folder = '6' ";
									$resultfi1 = mysqli_query($connection,$sqlfi1);
									while($rowfi1 = mysqli_fetch_object($resultfi1)){ ?>
						...
						<li>
							<a href="form_upload.php?id=<?php echo $row->SubjectID ?>">
						...
						<div class="time">
							<span>11 January - 17 March
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi12 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND TimeUpload> '2017-01-11' AND TimeUpload < '2017-03-17' ";
						...
						<div class="time">
							<span>11 April   - 17 June  
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi12 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND TimeUpload> '2017-04-11' AND TimeUpload < '2017-06-17' ";
									$resultfi2 = mysqli_query($connection,$sqlfi12);
									while($rowfi2 = mysqli_fetch_object($resultfi2)){ ?>
						...
						<div class="time">
							<span>11 July   - 17 September  
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi12 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND TimeUpload> '2017-07-11' AND TimeUpload < '2017-09-17' ";
									$resultfi2 = mysqli_query($connection,$sqlfi12);
									while($rowfi2 = mysqli_fetch_object($resultfi2)){ ?>
						...
						<div class="time">
							<span>11 October  - 17 December 
								<ul style="margin:0px 0 0 25px;">
								<?php 
									$sqlfi12 = "SELECT * FROM teacherupload WHERE SubjectID = '$idsj' AND AccountID ='$id' AND TimeUpload> '2017-10-11' AND TimeUpload < '2017-12-17' ";
									$resultfi2 = mysqli_query($connection,$sqlfi12);
									while($rowfi2 = mysqli_fetch_object($resultfi2)){ ?>
