								...
								<div class="content-user">
									<table class="table">
										<tr>
											...
											<td><label>Student Account</label></td>
										...
										<?php 
										$sqlfb = "select * from studentfeedback INNER JOIN account on studentfeedback.StudentID = account.AccountID where TeacherID = $id";
										$resultfb = mysqli_query($connection,$sqlfb);
										$i = 0;
										while($rowfb = mysqli_fetch_object($resultfb)){
										$i++;?>
										<tr>
											<td><?php echo$i ?></td>
											<td><?php echo$rowfb->AccountAcc ?></td>
											<td><?php echo$rowfb->AccountFullName ?></td>
											<td><?php echo$rowfb->MessageTitle ?></td>
											<td><?php echo$rowfb->MessageContent ?></td>
											<td><?php echo$rowfb->TimeFB ?></td>
											<td><a href="fbdelete.php?id=<?php echo$rowfb->StudentFeedbackID ?>">Delete</a></td>
										</tr>
										<?php } ?>
									</table>
					...
					<div class="col-md-4">
							...
							<div class="administration">
								...
								<ul>
									...
									<li><i class="fa fa-circle-o" aria-hidden="true"></i><a href="#">View feedback</a>
