				...
				<div class="categorypicker">
					...
					<div class="content-ctg">
						...
						<ul><?php
								...
								$sql = "SELECT * FROM subjects JOIN account on subjects.AccountID = account.AccountID JOIN classes on subjects.ClassID = classes.ClassID WHERE Position = 2 AND AccountAcc = '$name'";
									...
									<li>
										...
										<div class="info">
											...
											<ul>
												...
												<li><a class="info-ct" href="courseview.php?id=<?php echo$row->SubjectID?>"><i class="fa fa-star" aria-hidden="true"></i>0446 - <?php echo $row->ClassName?> - <?php echo$row->SubjectName?></a></li>
