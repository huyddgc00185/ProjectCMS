				...
				<div class="edit-pf">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<form class="form-signin" method="POST" enctype="multipart/form-data" action="function_edit/account.php">
								...
								<ul>
									...
									<?php 
									$idkk = $_GET['idst'];
										$sqlkk = "SELECT * FROM account where AccountID = '$idkk'";
										$resultkk = mysqli_query($connection,$sqlkk);
										$rowkk = mysqli_fetch_object($resultkk);
									 ?>
										...
										<input type="text" name="account" value="<?php echo ($rowkk->AccountAcc) ?>" class="form-control"  required>
									...
									<li>
										...
										<input type="text" name="name" value="<?php echo ($rowkk->AccountFullName) ?>" class="form-control"  required>
										...
										<input type="text" style="display: none" hidden="true" name="idaccount" value="<?php echo ($rowkk->AccountID) ?>" class="form-control"  required>
									<li>
									...
									<li>
										...
										<input type="email" name="email" id="inputEmail" class="form-control" value="<?php echo $rowkk->AccountEmail ?>" placeholder="Email address" required autofocus>
									...
									<li>
										...
										<input type="text" name="password" id="inputPassword" value="<?php echo ($rowkk->AccountPassword) ?>" class="form-control" placeholder="Password" required>
									...
									<li>
										...
										<input type="text" name="address" value="<?php echo ($rowkk->AccountAddress) ?>" class="form-control"  required>
									...
									<li>
										...
										<input type="text" name="phone" value="<?php echo ($rowkk->PhoneNumber) ?>" class="form-control" required>
									...
									<li>
										...
										<input class="form-control" id="date" value="<?php echo ($rowkk->DateOfBirth) ?>" name="day"  type="text"/>

									</li>

								</ul>

								<button class="btn-form" type="submit" name="editaccount">edit</button>
