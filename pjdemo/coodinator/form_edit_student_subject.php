		...
		<div id="main">
			...
			<div class="container">
				...
				<ol class="breadcrumb">
				  ...
				  <li>Form add student to subject</a></li>
					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-10 col-sm-10">
								...
								<form class="form-signin" method="POST" enctype="multipart/form-data" action="function_edit/studentsubject.php">
									...
									<ul>
										...
										<li>
											...
											<?php
												$idcls = $_GET['idsss'];
												$sqlcls="SELECT * FROM studentintosubject JOIN account on studentintosubject.StudentID = account.AccountID JOIN subjects on studentintosubject.SubjectID = subjects.SubjectID where StudentIntoSubjectID='$idcls'";
												$resultcls = mysqli_query($connection,$sqlcls);
												$rowcls = mysqli_fetch_object($resultcls); 
											?>
											<label><?php echo$rowcls->AccountFullName ?> </label>--> 

											<select style="width:200px;margin-left:-4px" name="selectst">

											<?php 

												$sqlte = "SELECT * FROM account where Position = '1'";
										...
										<li>
											...
											</lable><label><?php echo$rowcls->SubjectName ?> </label>--> 

											<select style="width:200px;margin-left:-4px" name="selects">

											<?php 

												$sqlc = "SELECT * FROM subjects ";

												$resultc = mysqli_query($connection,$sqlc);

												while($rowc = mysqli_fetch_object($resultc)){?>

														<option value="<?php echo$rowc->SubjectID?>"><?php echo$rowc->SubjectName?></option>
											...
											<input  hidden="true"  type="text" name="idstudentsubject" value="<?php echo$rowcl->StudentIntoSubjectID?>"   required>
										</li>

										<button class="btn-form" type="submit" name="editstudentsubject">Edit Student to Subject</button>
