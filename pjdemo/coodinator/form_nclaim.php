					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-10 col-sm-10">
								...
								<form class="form-signin" method="POST" action="nclaim.php" enctype="multipart/form-data" >
									...
									<ul>
										...
										<li>
											...
											<?php 
											$idtitle = $_GET['idclaim'];
											$sqltitle = "SELECT * FROM studentclaim where StudentClaimID = $idtitle ";
											$resultstitle = mysqli_query($connection,$sqltitle);
											$rowtitle = mysqli_fetch_object($resultstitle);
											?>
												Title:
											...
											<input style="width:85%;margin-left:-4px"  type="text" value="<Not Accepted <?php echo$rowtitle->StudentClaimSubject ?>>" name="subject"   placeholder="Input Subject" required>
										...
										<input hidden="true" style="width:85%;margin-left:-4px"  type="text" name="idst" value="<?php echo$_GET['idst']?>"  >
										<input hidden="true" style="width:85%;margin-left:-4px"  type="text" name="idclaim" value="<?php echo$_GET['idclaim']?>"   >

										

										<button class="btn-form" type="submit" name="answerclaim">Answer Claim</button>
