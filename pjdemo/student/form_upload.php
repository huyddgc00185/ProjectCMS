		...
		?>
			...
			<div class="container">
				...
				<div class="course-view">
					...
					<form class="form-signin" method="POST" enctype="multipart/form-data" action="upload_exam.php?id=<?php echo $row->AccountID ?>">
						...
						<ul>
							...
							<li>
								...
								<label>
									...
									<input type="text" name="idt" value="<?php echo$idt?>" hidden='true' autofocus>
