					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-10 col-sm-10">
								...
								<form class="form-signin" method="POST" enctype="multipart/form-data" action="add_class.php">
									...
									<ul>
										...
										<li>
											...
											<input style="width:85%;margin-left:-4px"  type="text" name="nameclass"   placeholder="Input Name Subject" required>
										...
										<button class="btn-form" type="submit" name="addclass">Add New Class</button>
