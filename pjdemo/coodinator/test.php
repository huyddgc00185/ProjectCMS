								...
								<div class="content-user">
									<table class="table">
										<tr>
											...
											<td><label>Days passed</label></td>
											<td><label>Status</label>
											<td colspan="2"><label style="margin-left: 32px">Action</label>
											
										</tr>
										<?php 
										$sqlclaim = "select * from studentclaim INNER JOIN account on studentclaim.StudentID = account.AccountID JOIN subjects on studentclaim.SubjectID = subjects.SubjectID where status = '0'";
										...
										<tr>
											...
											<td>
												<?php
													 ...
													 if($daypass>14){
													 	echo "<b style='color:red'>$daypass</b>";
											...
											<td><a class="btn-lg glyphicon-envelope" href="form_aclaim.php?idst=<?php echo$rowfb->StudentID?>&idclaim=<?php echo$rowfb->StudentClaimID?>"></a></td>
											<td><a href="form_nclaim.php?idst=<?php echo$rowfb->StudentID?>&idclaim=<?php echo$rowfb->StudentClaimID?>">X</a></td>
											
										</tr>
										<?php } ?>
									</table>
									<h1>If the claim that not yes answer over 14 day</h1>
