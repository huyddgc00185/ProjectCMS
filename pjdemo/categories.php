						...
						<ul>
							<li>
								<div class="info">
									...
									<ul>
										<li><a class="info-ct" href="courseview.php"><i class="fa fa-star" aria-hidden="true"></i>0446 - GCH0602Self enrolment</a></li>
										<li>
											<label><i class="fa fa-graduation-cap" aria-hidden="true"></i>Teacher: </label>
											<a href="#">(Khoa quốc tế ) Doãn Trung Tùng</a>
										</li>
									</ul>									
								</div>
							</li>
							<li>
								<div class="info">
									...
									<ul>
										<li><a class="info-ct" href="#"><i class="fa fa-star" aria-hidden="true"></i>0446 - GCH0602Self enrolment</a></li>
										<li>
											<label><i class="fa fa-graduation-cap" aria-hidden="true"></i>Teacher: </label>
											<a href="#">(Khoa quốc tế ) Doãn Trung Tùng</a>
										</li>
