					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-10 col-sm-10">
								...
								<form class="form-signin" method="POST" enctype="multipart/form-data" action="function_edit/class.php">
									...
									<ul>
										...
										<li>
											...
											<?php
												$idcl = $_GET['idcl'];
												$sqlcl="select * from classes where ClassID=$idcl";
												$resultcl = mysqli_query($connection,$sqlcl);
												$rowcl = mysqli_fetch_object($resultcl); 
											?>
											<input style="width:85%;margin-left:-4px"  type="text" name="nameclass" value="<?php echo$rowcl->ClassName ?>"   placeholder="Input Name Subject" required>
											<input style="width:85%;margin-left:-4px"  type="text" hidden="true" name="idclass" value="<?php echo$rowcl->ClassID ?>"    required>
										...
										<li>
											...
											<select style="width:200px;margin-left:-4px" name="selectsm">

											<?php 

												$sqlc = "SELECT * FROM semester ";

												$resultc = mysqli_query($connection,$sqlc);

												while($rowc = mysqli_fetch_object($resultc)){?>

														<option value="<?php echo$rowc->SemesterID?>"><?php echo$rowc->SemesterNo?></option>
										...
										<button class="btn-form" type="submit" name="editclass">Edit Class</button>
