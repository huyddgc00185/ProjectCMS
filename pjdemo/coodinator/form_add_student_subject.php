					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-10 col-sm-10">
								...
								<form class="form-signin" method="POST" enctype="multipart/form-data" action="add_student_subject.php">
									...
									<ul>
										...
										<button class="btn-form" type="submit" name="addstudentsubject">Add Student to Subject</button>
