					...
					<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-10 col-sm-10">
								...
								<form class="form-signin" method="POST" enctype="multipart/form-data" action="feedback.php">
									...
									<ul>
										...
										<li>
											...
											<input style="width:85%;margin-left:-4px"  type="text" name="title"   placeholder="Input title" required>
										...
										<li>
											...
											<TEXTAREA placeholder="Input message"  style="width:85%;height:180px;margin-left:-4px" name="messagefb" required></TEXTAREA>
										...
										<button class="btn-form" type="submit" name="sentfb">Sent Feedback</button>
